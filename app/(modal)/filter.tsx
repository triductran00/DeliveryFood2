  ...
  <>
    <View style={styles.itemContainer}>
      <TouchableOpacity style={styles.item}>
        ...
        <Text style={{ flex: 1 }}>Sắp xếp</Text>
    ...
    <Text style={styles.header}>Phân loại</Text>
  </>
);
        ...
        <View style={styles.btnContainer}>
          <Animated.View style={[animatedStyles, styles.outlineButton]}>
            <TouchableOpacity onPress={handleClearAll}>
              <Animated.Text style={[animatedText, styles.outlineButtonText]}>Xóa tất cả</Animated.Text>
            </TouchableOpacity>
          </Animated.View>

          <TouchableOpacity style={styles.fullButton} onPress={() => navigation.goBack()}>
            <Text style={styles.footerText}>Xong</Text>
          </TouchableOpacity>
        </View>
      </View>
    </View>
